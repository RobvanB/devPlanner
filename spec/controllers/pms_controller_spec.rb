...
RSpec.describe PmsController, type: :controller do
  ...
  describe "GET #new" do
    it "assigns a new pm as @pm" do
      ...
      expect(assigns(:pm)).to be_a_new(Pm)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created pm as @pm" do
        post :create, {:pm => valid_attributes}, valid_session
        expect(assigns(:pm)).to be_a(Pm)
        expect(assigns(:pm)).to be_persisted
      end

      it "redirects to the created pm" do
        post :create, {:pm => valid_attributes}, valid_session
        expect(response).to redirect_to(Pm.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved pm as @pm" do
        post :create, {:pm => invalid_attributes}, valid_session
        expect(assigns(:pm)).to be_a_new(Pm)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested pm" do
        pm = Pm.create! valid_attributes
        put :update, {:id => pm.to_param, :pm => new_attributes}, valid_session
        pm.reload
      ...
      it "redirects to the pm" do
        pm = Pm.create! valid_attributes
        put :update, {:id => pm.to_param, :pm => valid_attributes}, valid_session
        expect(response).to redirect_to(pm)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the pm as @pm" do
        pm = Pm.create! valid_attributes
        put :update, {:id => pm.to_param, :pm => invalid_attributes}, valid_session
        expect(assigns(:pm)).to eq(pm)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the pms list" do
      pm = Pm.create! valid_attributes
      delete :destroy, {:id => pm.to_param}, valid_session
      expect(response).to redirect_to(pms_url)
    end
  end
